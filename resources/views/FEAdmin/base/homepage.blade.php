...
@section('content')
<head>
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/vendor/fonts/circular-std/style.css') }}">
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/libs/css/style.css') }}">
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/vendor/charts/chartist-bundle/chartist.css') }}">
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/vendor/charts/morris-bundle/morris.css') }}">
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css') }}">
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/vendor/charts/c3charts/c3.css') }}">
  <link rel="stylesheet" href="{{ asset('css/FEAdmin/assets/vendor/fonts/flag-icon-css/flag-icon.min.css') }}">
</head>
